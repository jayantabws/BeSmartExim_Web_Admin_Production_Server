...
const EditSubscription = () => {
  const history = useHistory();
    const { id  } = useParams(); // Access the subscriptionId from the URL
  ...
  useEffect(() => {
    ...
    AxiosMaster({
      method: 'GET',
      url: `/masterdata-management/subscription/full/${id}`,
      headers: {
...
const api = res.data;
    ...
    price: api.price,
    validityDay: api.validityInDay,
    isCustom: api.isCustom,
    isActive: api.isActive,
    indepthAccess: api.indepthAccess,
    ...
    DOWNLOAD_LIMIT: api.otherAttributes?.DOWNLOAD_LIMIT?.keyValue || "",
    DOWNLOAD_LIMIT_keyFullName: api.otherAttributes?.DOWNLOAD_LIMIT?.keyFullName || "",
    DOWNLOAD_LIMIT_keyDesc: api.otherAttributes?.DOWNLOAD_LIMIT?.keyDesc || "",
    DOWNLOAD_LIMIT_valueDesc: api.otherAttributes?.DOWNLOAD_LIMIT?.valueDesc || "",

    MAX_DOWNLOAD_DAY: api.otherAttributes?.MAX_DOWNLOAD_DAY?.keyValue || "",
    MAX_DOWNLOAD_DAY_keyFullName: api.otherAttributes?.MAX_DOWNLOAD_DAY?.keyFullName || "",
    MAX_DOWNLOAD_DAY_keyDesc: api.otherAttributes?.MAX_DOWNLOAD_DAY?.keyDesc || "",
    MAX_DOWNLOAD_DAY_valueDesc: api.otherAttributes?.MAX_DOWNLOAD_DAY?.valueDesc || "",

    WORKSPACE: api.otherAttributes?.WORKSPACE?.keyValue || "",
    WORKSPACE_keyFullName: api.otherAttributes?.WORKSPACE?.keyFullName || "",
    WORKSPACE_keyDesc: api.otherAttributes?.WORKSPACE?.keyDesc || "",
    WORKSPACE_valueDesc: api.otherAttributes?.WORKSPACE?.valueDesc || "",

    SUPPORT: api.otherAttributes?.SUPPORT?.keyValue || "",
    SUPPORT_keyFullName: api.otherAttributes?.SUPPORT?.keyFullName || "",
    SUPPORT_keyDesc: api.otherAttributes?.SUPPORT?.keyDesc || "",
    SUPPORT_valueDesc: api.otherAttributes?.SUPPORT?.valueDesc || "",

    TICKET_MANAGER: api.otherAttributes?.TICKET_MANAGER?.keyValue || "",
    TICKET_MANAGER_keyFullName: api.otherAttributes?.TICKET_MANAGER?.keyFullName || "",
    TICKET_MANAGER_keyDesc: api.otherAttributes?.TICKET_MANAGER?.keyDesc || "",
    TICKET_MANAGER_valueDesc: api.otherAttributes?.TICKET_MANAGER?.valueDesc || "",

    RECORD_PER_WORKSPACE: api.otherAttributes?.RECORD_PER_WORKSPACE?.keyValue || "",
    RECORD_PER_WORKSPACE_keyFullName: api.otherAttributes?.RECORD_PER_WORKSPACE?.keyFullName || "",
    RECORD_PER_WORKSPACE_keyDesc: api.otherAttributes?.RECORD_PER_WORKSPACE?.keyDesc || "",
    RECORD_PER_WORKSPACE_valueDesc: api.otherAttributes?.RECORD_PER_WORKSPACE?.valueDesc || "",

    SUB_USER: api.otherAttributes?.SUB_USER?.keyValue || "",
    SUB_USER_keyFullName: api.otherAttributes?.SUB_USER?.keyFullName || "",
    SUB_USER_keyDesc: api.otherAttributes?.SUB_USER?.keyDesc || "",
    SUB_USER_valueDesc: api.otherAttributes?.SUB_USER?.valueDesc || "",

    DISPLAY_FIELDS: api.otherAttributes?.DISPLAY_FIELDS?.keyValue || "",
    DISPLAY_FIELDS_keyFullName: api.otherAttributes?.DISPLAY_FIELDS?.keyFullName || "",
    DISPLAY_FIELDS_keyDesc: api.otherAttributes?.DISPLAY_FIELDS?.keyDesc || "",
    DISPLAY_FIELDS_valueDesc: api.otherAttributes?.DISPLAY_FIELDS?.valueDesc || "",

    QUERY_PER_DAY: api.otherAttributes?.QUERY_PER_DAY?.keyValue || "",
    QUERY_PER_DAY_keyFullName: api.otherAttributes?.QUERY_PER_DAY?.keyFullName || "",
    QUERY_PER_DAY_keyDesc: api.otherAttributes?.QUERY_PER_DAY?.keyDesc || "",
    QUERY_PER_DAY_valueDesc: api.otherAttributes?.QUERY_PER_DAY?.valueDesc || "",

    DATA_ACCCESS: api.otherAttributes?.DATA_ACCCESS?.keyValue || "",
    DATA_ACCCESS_keyFullName: api.otherAttributes?.DATA_ACCCESS?.keyFullName || "",
    DATA_ACCCESS_keyDesc: api.otherAttributes?.DATA_ACCCESS?.keyDesc || "",
    DATA_ACCCESS_valueDesc: api.otherAttributes?.DATA_ACCCESS?.valueDesc || "",

    ALLOWED_CHAPTER: api.otherAttributes?.ALLOWED_CHAPTER?.keyValue || "",
    ALLOWED_CHAPTER_keyFullName: api.otherAttributes?.ALLOWED_CHAPTER?.keyFullName || "",
    ALLOWED_CHAPTER_keyDesc: api.otherAttributes?.ALLOWED_CHAPTER?.keyDesc || "",
    ALLOWED_CHAPTER_valueDesc: api.otherAttributes?.ALLOWED_CHAPTER?.valueDesc || "",
  };
...
/*
  const handleSubmit = () => {
    ...
    AxiosMaster({
      method: 'PUT',
      url: `/masterdata-management/subscription/${id}`,
  ...
  const updateSubscription = (values, actions) => {
    ...
    AxiosMaster({
      ...
      headers: {
        ...
        Swal.fire({
          title: 'Thank You',
          text: "Your updated is successful",
          icon: 'success',
        });
         history.push("/subscription/subscriptionList");
      ...
      <div className="page-header">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active" aria-current="page"> <h3 className="page-title"> Update subscription </h3></li>
            </ol>
          </nav>        
      </div>
      <div className="row">
...
{/* {JSON.stringify(subscriptionData)} */}
                                      ...
                                      <div >                   
                                          <FormGroup>
                                            <div className="formSection">      
                                             ...
                                             <Select
  key={JSON.stringify(tradeCountryList)}
  ...
  onChange={(selectedOption) => {
    setFieldValue(
      "countryId",
      selectedOption?.map(i => i.value.trim()) || []
    );
  }}
